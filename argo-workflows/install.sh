...
kubectl apply -f https://raw.githubusercontent.com/tico24/argo-workflows-intro-course/master/config/minio/minio.yaml  > /dev/null
kubectl apply -f https://raw.githubusercontent.com/tico24/argo-workflows-intro-course/master/config/argo-workflows/canary-workflow.yaml > /dev/null
kubectl apply -f https://raw.githubusercontent.com/tico24/argo-workflows-intro-course/master/config/argo-workflows/patchpod.yaml > /dev/null
kubectl apply -f https://raw.githubusercontent.com/tico24/argo-workflows-intro-course/master/config/argo-workflows/workflows-controller-configmap.yaml > /dev/null
